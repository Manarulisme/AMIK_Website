...
Route::get('/sejarah', [FrontController::class, 'sejarah']);
...
Route::get('/inforisets', [FrontController::class, 'inforisets']);
Route::get('/prosedur-riset', [FrontController::class, 'prosedurrisets']);
Route::get('/penerimaan-mahasiswa-baru', [FrontController::class, 'pmbs']);
Route::get('/penerimaan-beasiswa', [FrontController::class, 'beasiswas']);
Route::get('/penerimaan-penghargaan', [FrontController::class, 'penghargaans']);
