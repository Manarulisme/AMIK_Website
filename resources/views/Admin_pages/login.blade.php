...
<head>
  ...
  <title>Login Sistem Website AMIK</title>
...
<div class="login-box">
  <div class="login-logo">
    <img src="{{ asset('Assets/Images/logo/logo_amik.png') }}" alt="" width="70px" height="70px"></br>
    <span style="font-size: 20px; font-weight:400;">Sistem Manajemen Website AMIK</span>
  </div>
  <!-- /.login-logo -->
  <div class="card">
