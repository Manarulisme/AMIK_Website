                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('agendaterdekat.destroy', $agenda->id) }}" method="POST">
                                        <a href="{{ route('agendaterdekat.show', $agenda->id) }}" class="btn btn-sm btn-dark">SHOW</a>
                                        <a href="{{ route('agendaterdekat.edit', $agenda->id) }}" class="btn btn-sm btn-primary">EDIT</a>
                                        @csrf
                                        @method('DELETE')
