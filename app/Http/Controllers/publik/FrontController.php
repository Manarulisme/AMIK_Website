...
class FrontController extends Controller
{
    ...
    public function inforisets(): View{

        $inforisets = Post::where('headline','Tidak')->where('kategori_id','3')->orderBy('id', 'desc')->paginate(12);
        return view('pages.riset.informasi_riset', compact('inforisets'));
    }

    public function prosedurrisets(): View{

        $prosedurrisets = Post::where('headline','Tidak')->where('kategori_id','8')->orderBy('id', 'desc')->paginate(12);
        return view('pages.riset.prosedur_riset', compact('prosedurrisets'));
    }

    public function pmbs(): View{
    ...
    public function beasiswas(): View{

        $beasiswas = Post::where('headline','Tidak')->where('kategori_id','11')->orderBy('id', 'desc')->paginate(12);
        return view('pages.penerimaan.penerimaan_beasiswa', compact('beasiswas'));
    }

    public function penghargaans(): View{

        $penghargaans = Post::where('headline','Tidak')->where('kategori_id','12')->orderBy('id', 'desc')->paginate(12);
        return view('pages.penerimaan.penerimaan_penghargaan', compact('penghargaans'));
    }
